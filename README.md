...
* [`src/tdcj/`](src/tdcj/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/tdcj/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `tdcj` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/tdcj/config.cljs) defaults to `true` in
